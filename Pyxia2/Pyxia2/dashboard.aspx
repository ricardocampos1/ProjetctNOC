                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Olá, Duffoux </h4>
                        </div>
                    </div>
                </div>
            </div>
                                                        ...
                                                        <div class="d-sm-flex justify-content-between ">
                                                            <div class="col-8">
                                                                <div id="verview-shart">
                                                                    ...
                                                                    <canvas class="line-chart" width="600" height="350"></canvas>
                                                        ...
                                                        <div class="d-sm-flex justify-content-between ">
                                                            <div class="col-8">
                                                                <div id="verview-xhart">
                                                                    <!--Tag que sera manipulada por todo script para apresentação do grafico-->
                                                                    <canvas class="line" width="600" height="350"></canvas>
                                                                    <!--Biblioteca do Chart.js para apresentação do grafico -->
                                                                    <script>
                                                                        //Variavel javascript que faz referencia com a tag line-chart( para apresentação do grafico)
