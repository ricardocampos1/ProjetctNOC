                   ...
                   <div class="form">
                    <h2 class="title">Cadastro</h2>
                       ...
                       <form class="formulario" runat="server">                     
                        ...
                        <asp:TextBox ID="txtpergunta" runat="server" CssClass="input0" />
                        <asp:TextBox ID="txtemail" placeholder="digite seu e-mail" runat="server" CssClass="input1"></asp:TextBox>
                        <asp:TextBox ID="txtnome" placeholder="digite seu usuário para login" runat="server" CssClass="input2"></asp:TextBox>
                        ...
                        <asp:Button ID="BtnCadastra" runat="server" Text="Cadastrar" CssClass="botão"/>
