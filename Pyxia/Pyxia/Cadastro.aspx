...
<form class="modal-content"id="regForm">
 ...
 <div class="container">
  ...
  <div class="tab">Nome:
    <p><input placeholder="Nome Completo..." oninput="this.className = ''" name="cnname"></p>
    <p><input placeholder="Nome de Usuário..." oninput="this.className = ''" name="usname"></p>
  </div>
  <div class="tab">Informações de Contato:
    <p><input placeholder="E-mail..." oninput="this.className = ''" name="email"></p>
    <p><input placeholder="Confirma E-mail..." oninput="this.className = ''" name="cemail"></p>
  </div>
  <div class="tab">Aniversário:
    <input placeholder="Data de Nascimento" class="input--style-2" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date">
                              
  </div>
  <div class="tab">Informações de Endereço:
      <p><input class="input--style-4" type="text" maxlength="10" placeholder="CEP" name="CEP"></p>
     ...
     <p><input class="input--style-3" type="text" maxlength="30" placeholder="Rua" name="Rua"></p>
      <p><input class="input--style-3" type="text" maxlength="50" placeholder="Complemento" name="Complemento"></p>

  </div>
  <div class="tab">Senha:
    <p><input placeholder="Senha..." oninput="this.className = ''" name="pword" type="password"></p>
    <p><input placeholder="Confirma Senha..." oninput="this.className = ''" name="pword" type="password"></p>
  </div>
