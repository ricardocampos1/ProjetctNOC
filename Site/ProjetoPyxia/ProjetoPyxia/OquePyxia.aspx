    ...
    <div class="container-pyxia">
			<div>
				...
				<div class="description-row">
					<p>Inpirada na constelação Pyxie,  que significa bússola, a Pyxia
					...
					<p>Composta por um programa e uma aplicação web com
				...
				<div class="pyxia-wrapper">
						...
						<div class="pyxia-desc">
							<p> Pyx será seu guia e estará sempre pronto para te ajudar a navegar
									pelo site e tirar suas dúvidas.</p>
							<p> Conversar com ele é muito simples, basta um clique na foto dele que
